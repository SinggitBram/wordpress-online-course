...
Global password protection, complete pages, posts, products(WooCommerce) or only parts of them with the integrated shortcode.
...
**Global Protection**
Edit a page/post and activate the global protection. Every user will be redirected to that page as the correct password was submitted.

**Page Protection**
Edit a page and activate the page protection. This blocks the entire content of the page while keep things like your navigation and layout as it is.

**Partly Protection**
Use the shortcode included in Passster to protect only parts of your content.
...
**Widgets and ACF**
As of version 3.4 Passster also supports the usage of the shortcode within fields created with Advanced Custom Fields and within Widgets (text widgets).

**Free**

* restrict your entire website with a password
* restrict complete pages/posts/products with a password
* use a simple shortcode to protect parts of your content
* ajax-driven unlock - no page reload required (optional)
...
* Google ReCaptcha v3 (invisible Captcha) or v2(Checkbox)
* password lists for large sets of passwords
* expire passwords from a list after one time usage, after a number of usages or by time (hours, days, weeks, months)
* protect Visual composer rows
* auto-unlock content per user and user role
* modify description, headline, buttons and more on a page level
